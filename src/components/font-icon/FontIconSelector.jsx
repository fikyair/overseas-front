...
export default class FontIconSelector extends Component {
    ...
    render() {
        ...
        return (
            <div className="select-font-icon">
                            ...
                            <div key={index}>
                                ...
                                <div>
                                    {icon.icons.map((ic, i) => (
                                        <span
                                            key={i}
                                            className={selectedIcon === ic ? 'active icon-wrapper' : 'icon-wrapper'}
                                            onClick={() => this.handleSelect(ic)}
                                            onDoubleClick={() => this.handleSubmit(ic)}
                                        >
                                            <FontIcon type={ic} size="2x"/>
                                            <span className="icon-class">{ic}</span>
                                        </span>
                                    ))}
                                </div>
                            </div>
